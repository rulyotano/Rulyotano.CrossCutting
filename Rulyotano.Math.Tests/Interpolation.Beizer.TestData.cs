...
namespace Rulyotano.Math.Tests
{
    ...
    public static class TestDataBeizer
    {
        public static TestCaseBeizer TestCas1
        {
            get
            {
        ...
        public static TestCaseBeizer TestCas2
        {
            get
            {
                Point point1 = new Point(173, 42);
        ...
        public static TestCaseBeizer TestCas3
        {
            get
            {
                Point point1 = new Point(173, 42);
